                    ...
                    <div class="brxc-overlay__pannels-wrapper">
                        ...
                        <div class="brxc-overlay__pannel brxc-overlay__pannel-1">
                            ...
                            <div class="brxc-overlay__search-box">
                                <input type="search" class="iso-search" name="dynamic-data-search" placeholder="Type here to filter the dynamic tags" oninput="ADMINBRXC.dynamicDataStates.search = this.value;ADMINBRXC.dynamicDataMount();">
