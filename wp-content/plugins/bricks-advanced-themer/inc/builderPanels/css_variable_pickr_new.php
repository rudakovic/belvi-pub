                            ...
                            <div class="brxc-overlay__pannel--content">
                                ...
                                if ( ! empty( $row ) ) {
                                    ...
                                    if(AT__Helpers::is_array($core_settings) ){
                                        ...
                                        // Typography
                                        if(AT__Helpers::is_value($typography_obj) && AT__Helpers::is_value($typography_obj, 'namingConvention')){?>
                                        ...
                                        // Spacing
                                        if(AT__Helpers::is_value($spacing_obj) && AT__Helpers::is_value($spacing_obj, 'namingConvention')){?>
                                            <div class="brxc-variable-picker__category">
