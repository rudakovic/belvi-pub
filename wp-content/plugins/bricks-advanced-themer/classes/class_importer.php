            ...
            while (have_rows('field_63b59j871b209', 'bricks-advanced-themer')) : the_row();
                if (have_rows('field_63b4bd5c16ac1', 'bricks-advanced-themer')) :
                    while (have_rows('field_63b4bd5c16ac1', 'bricks-advanced-themer')) :
                        ...
                        if ((function_exists('bricks_is_builder') && bricks_is_builder() && function_exists('bricks_is_builder') && !bricks_is_builder_iframe()) || !isset($class_importer_label) || !isset($priority) || !isset($position) || !isset($class_importer_file) || !isset($class_importer_version)) return;
