...
function ColorPicker(t, e) {
    (this.element = t),
        ...
        t.addEventListener("click", function () {
            (colorPickerComp.instance = this.colorPickerObj), (colorPickerComp.pickerOpen = !0);
            const t = document.getElementById("color_picker");
            t.style.display = "block";
            let e = this.getBoundingClientRect().top,
                o = this.getBoundingClientRect().left;
            if (((e = e + t.offsetHeight > window.innerHeight ? e - t.offsetHeight - 2 : e + this.offsetHeight + 2), o + t.offsetWidth > window.innerWidth - 20)) {
                o = o - (o + t.offsetWidth - window.innerWidth) - 20;
            }
            (t.style.top = e + "px"), (t.style.left = o + "px"), colorPickerComp.updateColorDisplays(this.getAttribute("data-color")), document.getElementById("color_text_values").focus();
        });
}
!(function () {
    ...
    if (
        ...
        for (let t = colorPickerComp.LSCustomColors[0].length - 1; t >= 0; t--) {
            ...
            (e.className = "custom_colors_preview"),
                ...
                e.setAttribute("data-custom-color", colorPickerComp.LSCustomColors[0][t]),
                document.getElementById("custom_colors_box").appendChild(e),
                19 == t && (document.getElementById("custom_colors_add").style.display = "none");
        }
        28 == colorPickerComp.LSCustomColors[0].length && (document.getElementById("custom_colors_add").style.display = "none");
    }
})(),
    (colorPickerComp.keyShortcuts = function (t) {
        for (let t in document.getElementsByTagName("INPUT")) if (!isNaN(t) && document.getElementsByTagName("INPUT")[t] === document.activeElement) return;
        for (let t in document.getElementsByTagName("TEXTAREA")) if (!isNaN(t) && document.getElementsByTagName("TEXTAREA")[t] === document.activeElement) return;
        switch (t.keyCode) {
            case 46:
                "custom_colors_preview" == document.activeElement.className && colorPickerComp.clearSingleCustomColor(document.activeElement);
                break;
            case 27:
            ...
            case 9:
                ...
                for (; t.length > 0; ) t[0].classList.add("add_outline"), t[0].classList.remove("remove_outline"), (t = document.getElementsByClassName("remove_outline"));
        }
    }),
    ...
    document.addEventListener("mousedown", function () {
        ...
        for (; t.length > 0; ) t[0].classList.add("remove_outline"), t[0].classList.remove("add_outline"), (t = document.getElementsByClassName("add_outline"));
    }),
    document.addEventListener("mousedown", function () {
        "color_context_menu" != event.target.id && (document.getElementById("color_context_menu").style.display = "none");
    });
let closePicker = function () {
        (colorPickerComp.pickerOpen = !1), (document.getElementById("color_picker").style.display = "none"), "undefined" != colorPickerComp.instance.element.getAttribute("data-color") && updatePicker();
    },
    updatePicker = function () {
        colorPickerComp.colorChange({ h: colorPickerComp.hue, s: colorPickerComp.saturation, l: colorPickerComp.lightness, a: colorPickerComp.alpha });
    };
document.addEventListener("mousedown", function () {
    let t = event.target;
    ...
    (colorPickerComp.colorChange = function (t, e) {
        ...
        const o = colorPickerComp.HSLAToRGBA(t.h, t.s, t.l, t.a),
            ...
            c = new CustomEvent("colorChange", {
                detail: { color: { hsl: `hsla(${t.h}, ${t.s}%, ${t.l}%)`, rgb: `rgba(${o.r}, ${o.g}, ${o.b})`, hex: l, hsla: `hsla(${t.h}, ${t.s}%, ${t.l}%, ${t.a})`, rgba: `rgba(${o.r}, ${o.g}, ${o.b}, ${o.a})`, hexa: l } },
            }),
            r = void 0 === e ? colorPickerComp.instance.element : e;
        r.setAttribute("data-color", l), (r.style.background = l), r.dispatchEvent(c);
    }),
    (colorPickerComp.HSLAToRGBA = function (t, e, o, l, c) {
        ...
        return (
            ...
            !0 === c ? colorPickerComp.RGBAToHexA(s, a, u, l) : { r: s, g: a, b: u, a: l }
        );
    }),
    (colorPickerComp.RGBAToHSLA = function (t, e, o, l) {
        ...
        let c = Math.min(t, e, o),
            ...
            a = 0;
        return (
            (i = 0 == n ? 0 : r == t ? ((e - o) / n) % 6 : r == e ? (o - t) / n + 2 : (t - e) / n + 4),
            (i = Math.round(60 * i)),
            i < 0 && (i += 360),
            (a = (r + c) / 2),
    ...
    (colorPickerComp.hexAToRGBA = function (t, e) {
        ...
        return (
            5 == t.length
                ? ((o = "0x" + t[1] + t[1]), (l = "0x" + t[2] + t[2]), (c = "0x" + t[3] + t[3]), (r = "0x" + t[4] + t[4]))
                : 9 == t.length && ((o = "0x" + t[1] + t[2]), (l = "0x" + t[3] + t[4]), (c = "0x" + t[5] + t[6]), (r = "0x" + t[7] + t[8])),
            (r = +(r / 255).toFixed(3)),
            !0 === e ? colorPickerComp.RGBAToHSLA(+o, +l, +c, r) : "rgba(" + +o + "," + +l + "," + +c + "," + r + ")"
        );
    }),
    (colorPickerComp.switchColorType = function () {
        if ("HEXA" == colorPickerComp.colorTypeStatus) {
            (colorPickerComp.colorTypeStatus = "RGBA"), (document.getElementById("hexa").style.display = "none"), (document.getElementById("rgba").style.display = "block");
            const t = colorPickerComp.HSLAToRGBA(colorPickerComp.hue, colorPickerComp.saturation, colorPickerComp.lightness, colorPickerComp.alpha);
            ...
            (colorPickerComp.colorTypeStatus = "HEXA"), (document.getElementById("hsla").style.display = "none"), (document.getElementById("hexa").style.display = "block");
            const t = colorPickerComp.HSLAToRGBA(colorPickerComp.hue, colorPickerComp.saturation, colorPickerComp.lightness, colorPickerComp.alpha, !0);
    ...
    document.getElementById("hex_input").addEventListener("blur", function () {
        const t = this.value;
        t.match(/^#[0-9a-fA-F]{3}([0-9a-fA-F]{3})?([0-9a-fA-F]{2})?$/) && (colorPickerComp.updateColorDisplays(t), updatePicker());
    }),
    document.getElementById("hex_input").addEventListener("keyup", function (e) {
        if(e.key === "Enter" || e.key === "Tab"){
            const t = this.value;
            t.match(/^#[0-9a-fA-F]{3}([0-9a-fA-F]{3})?([0-9a-fA-F]{2})?$/) && (colorPickerComp.updateColorDisplays(t), updatePicker());
       } else {
            const t = this.value;
            t.match(/^#[0-9a-fA-F]{6}$/) && (colorPickerComp.updateColorDisplays(t), updatePicker());
       }
   }),
    document.querySelectorAll(".rgba_input").forEach((t) => {
        t.addEventListener("change", function () {
            ...
            colorPickerComp.updateColorDisplays(`rgba(${t[0].value}, ${t[1].value}, ${t[2].value}, ${t[3].value})`), updatePicker();
        });
    }),
    document.querySelectorAll(".hsla_input").forEach((t) => {
        t.addEventListener("change", function () {
            ...
            if (t[3].value > 1) throw "Value must be equal to or below 1";
            colorPickerComp.updateColorDisplays(`hsla(${t[0].value}, ${t[1].value}%, ${t[2].value}%, ${t[3].value})`), updatePicker();
        });
    }),
    ...
    //     19 == colorPickerComp.LSCustomColors[0].length && (document.getElementById("custom_colors_add").style.display = "none");
    ...
    //         (e.style.display = "block"), (e.style.top = t.target.getBoundingClientRect().top + 25 + "px"), (e.style.left = t.target.getBoundingClientRect().left + "px"), (colorPickerComp.contextMenuElem = t.target);
    //     }
    // }),
    // (colorPickerComp.clearSingleCustomColor = function (t) {
    //     const e = void 0 === t ? colorPickerComp.contextMenuElem : t;
    //     document.getElementById("custom_colors_box").removeChild(e), (colorPickerComp.LSCustomColors = { 0: [] });
    //     for (let t in document.getElementsByClassName("custom_colors_preview")) !0 !== isNaN(t) && colorPickerComp.LSCustomColors[0].push(document.getElementsByClassName("custom_colors_preview")[t].getAttribute("data-custom-color"));
    //     localStorage.setItem("custom_colors", JSON.stringify(colorPickerComp.LSCustomColors)), (document.getElementById("custom_colors_add").style.display = "inline-block");
    // }),
    ...
    //     for (colorPickerComp.LSCustomColors = { 0: [] }; document.getElementsByClassName("custom_colors_preview").length > 0; )
    ...
    (colorPickerComp.colorSliderHandler = function (t) {
        ...
        (colorPickerComp.hue = r),
            document.getElementById("saturation").children[1].setAttribute("stop-color", `hsla(${r}, 100%, 50%, ${colorPickerComp.alpha})`),
    ...
    document.getElementById("color_slider").addEventListener("mousedown", function (t) {
        (colorPickerComp.sliderStatus = !0), colorPickerComp.colorSliderHandler(t.pageX);
    }),
    document.addEventListener("mousemove", function (t) {
        !0 === colorPickerComp.sliderStatus && colorPickerComp.colorSliderHandler(t.pageX);
    }),
    ...
    document.getElementById("color_slider").addEventListener(
        "touchstart",
        function (t) {
            (colorPickerComp.sliderStatusTouch = !0), colorPickerComp.colorSliderHandler(t.changedTouches[0].clientX);
        },
        { passive: !0 }
    ),
    document.addEventListener(
        "touchmove",
        function () {
            !0 === colorPickerComp.sliderStatusTouch && (event.preventDefault(), colorPickerComp.colorSliderHandler(event.changedTouches[0].clientX));
        },
        { passive: !1 }
    ),
    document.addEventListener("touchend", function () {
        !0 === colorPickerComp.sliderStatusTouch && (colorPickerComp.sliderStatusTouch = !1);
    }),
    (colorPickerComp.opacitySliderHandler = function (t) {
        ...
        (c = Number(Math.round(c + "e2") + "e-2")), (colorPickerComp.alpha = c), colorPickerComp.updateColorValueInput(), colorPickerComp.instance.element.setAttribute("data-color", "color"), updatePicker();
    }),
    document.getElementById("opacity_slider").addEventListener("mousedown", function (t) {
        (colorPickerComp.opacityStatus = !0), colorPickerComp.opacitySliderHandler(t.pageX);
    }),
    document.addEventListener("mousemove", function (t) {
        !0 === colorPickerComp.opacityStatus && colorPickerComp.opacitySliderHandler(t.pageX);
    }),
    document.addEventListener("mouseup", function () {
        !0 === colorPickerComp.opacityStatus && (colorPickerComp.opacityStatus = !1);
    }),
    document.getElementById("opacity_slider").addEventListener(
        "touchstart",
        function (t) {
            (colorPickerComp.opacityStatusTouch = !0), colorPickerComp.opacitySliderHandler(t.changedTouches[0].clientX);
        },
        { passive: !0 }
    ),
    document.addEventListener(
        "touchmove",
        function () {
            !0 === colorPickerComp.opacityStatusTouch && (event.preventDefault(), colorPickerComp.opacitySliderHandler(event.changedTouches[0].clientX));
        },
        { passive: !1 }
    ),
    document.addEventListener("touchend", function () {
        !0 === colorPickerComp.opacityStatusTouch && (colorPickerComp.opacityStatusTouch = !1);
    }),
    (colorPickerComp.colorBoxHandler = function (t, e, o) {
        ...
        let r = t - l.getBoundingClientRect().left,
            n = !0 === o ? e - l.getBoundingClientRect().top : e - l.getBoundingClientRect().top - document.getElementsByTagName("HTML")[0].scrollTop;
        r < 14 && (r = 14), r > 252 && (r = 252), n < 14 && (n = 14), n > 119 && (n = 119), (c.attributes.y.nodeValue = n), (c.attributes.x.nodeValue = r);
        const i = Math.round(((r - 15) / 238) * 100),
            s = 100 - i / 2,
            a = 100 - ((n - 15) / 105) * 100,
            u = Math.floor((a / 100) * s);
        (colorPickerComp.saturation = i), (colorPickerComp.lightness = u), colorPickerComp.updateColorValueInput(), colorPickerComp.instance.element.setAttribute("data-color", "color"), updatePicker();
    }),
    document.getElementById("color_box").addEventListener("mousedown", function (t) {
        (colorPickerComp.boxStatus = !0), colorPickerComp.colorBoxHandler(t.pageX, t.pageY);
    }),
    document.addEventListener("mousemove", function (t) {
        !0 === colorPickerComp.boxStatus && colorPickerComp.colorBoxHandler(t.pageX, t.pageY);
    }),
    ...
    document.getElementById("color_box").addEventListener(
        "touchstart",
        function (t) {
            (colorPickerComp.boxStatusTouch = !0), colorPickerComp.colorBoxHandler(t.changedTouches[0].clientX, t.changedTouches[0].clientY, !0);
        },
        { passive: !0 }
    ),
    document.addEventListener(
        "touchmove",
        function () {
            !0 === colorPickerComp.boxStatusTouch && (event.preventDefault(), colorPickerComp.colorBoxHandler(event.changedTouches[0].clientX, event.changedTouches[0].clientY, !0));
        },
        { passive: !1 }
    ),
    document.addEventListener("touchend", function () {
        !0 === colorPickerComp.boxStatusTouch && (colorPickerComp.boxStatusTouch = !1);
    }),
    (colorPickerComp.updateColorDisplays = function (t) {
        if ("undefined" == t) t = { h: 0, s: 100, l: 50, a: 1 };
            ...
            const e = t.match(/[.?\d]+/g);
            (e[3] = null == e[3] ? 1 : e[3]), (t = colorPickerComp.RGBAToHSLA(e[0], e[1], e[2], e[3]));
        } else {
            const e = t.match(/[.?\d]+/g);
        ...
        (colorPickerComp.hue = t.h),
            ...
            colorPickerComp.updateColorValueInput(),
            document.getElementById("saturation").children[1].setAttribute("stop-color", `hsl(${t.h}, 100%, 50%)`);
        const e = document.getElementById("box_dragger");
        let o = 2.38 * t.s + 14;
        let l = 1.05 * (100 - (t.l / (100 - t.s / 2)) * 100) + 14;
        o < 14 && (o = 14), o > 252 && (o = 252), l < 14 && (l = 14), l > 119 && (l = 119), (e.attributes.x.nodeValue = o), (e.attributes.y.nodeValue = l);
